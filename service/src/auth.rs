...
use shared_gen::auth::auth_service_server::{AuthService, AuthServiceServer};
use shared_gen::auth::{RegistrationRequest, RegistrationResponse, UpdateLobbyNicknameRequest, UpdateLobbyNicknameResponse};
